...
if ($connect_with_db->connect_errno > 0)
{
    ...
    $sql_number_messages = "SELECT * FROM messages_clients WHERE new =1  AND answer=1 ORDER BY id DESC";
...
<?php
if ( isset($_SESSION['is_delete_admin_ans']) && $_SESSION['is_delete_admin_ans'] == true)
    echo $_SESSION['is_delete_admin_ans'];
unset($_SESSION['is_delete_admin_ans']);
...
$_SESSION['previous_page']= "answered";
