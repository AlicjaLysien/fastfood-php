...
END;
                ...
                echo "<img class='menuphotoitem align-self-center' src='img/pizza/pizza0" . $i . ".png'> ";
...
END;
                ...
                echo "<p>price: <br>small: ". $row['small']. " czk<br>big: " . $row['big'] ." czk</p>";
...
echo <<<END
                            ...
                            <div class="menuorder col-sm-12 d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target=".bd-example-modal-sm">Add small pizza
                                </button>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="recipient-name" class="col-form-label">Pizza was added
                                                        to your cart!</label>
                                                </div>
                                            </div>
                                ...
                                <!-- add big pizza-->
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target=".bd-example-modal-sm">Add big pizza
                                </button>
