...
<form action="login_action.php" method="post">
  <div class="form-group">
    ...
    <div class=" d-flex justify-content-center">
    <input type="email" name="login_email" class="form-control formwindow" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
</div>
  <div class="form-group">
    <div class=" d-flex justify-content-center">
    ...
    <div class=" d-flex justify-content-center">
    <input type="password" name="login_password" class="form-control formwindow" id="exampleInputPassword1">
  </div>
  </div>
