...
echo "<img class='menuphotoitem align-self-center' src='img/sushi/sushi0".$i.".png' >";
...
echo "<p>price <br> 6 pc.: ".$row['small']." czk <br> 10 pc.: ".$row['big']." czk</p>";
...
<!-- add small sushi-->
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm">Add 6 pieces</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Sushi was added to your cart!</label>
            </div>
        </div>
...
&nbsp;&nbsp;
<!-- add big sushi-->
<button type="button" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm">Add 10 pieces</button>
