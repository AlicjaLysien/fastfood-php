...
echo "<img class='menuphotoitem align-self-center' src='img/drink/drink0".$i.".png'>";
...
echo "<h3>".$row['name']."</h3>";
echo "<p>".$row['description']."</p></div><div class='menuprice col-sm-5'>";
...
<!-- add drink-->
<button type="button" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm">Add drink</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Drink was added to your cart!</label>
          </div>
      </div>
